...
{
	int         ret = MSP_SUCCESS;
	const char* login_params = "appid = NULL, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
																/*
																* rdn:           合成音频数字发音方式
																* volume:        合成音频的音量
																* pitch:         合成音频的音调
	...
	const char* text = "马教授经常是心不在焉的，或者说，他太专注于自己的思索了。“我的鞋子呢？”下课的时候，马教授喃喃自语道。“在你的脚上呢。”李同学说。“哦，就是。多亏你看见了，不然的话，我只有光着脚回家了。"; //合成文本
																							 /* 用户登录 */
