//#include"stdafx.h"//若在mfc下使用需要加这个
...
int AutoRecord::vda_bos = 0, AutoRecord::vda_eos = 0, AutoRecord::eos_flag = 0;
...
SpecRe::SpecRe()
{
	...
	login_params = "appid = NULL, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
